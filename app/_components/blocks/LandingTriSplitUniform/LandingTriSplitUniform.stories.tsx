...
import { LandingTriSplitUniform } from "./LandingTriSplitUniform";

const meta = {
  title: "Blocks/LandingTriSplitUniform",
  component: LandingTriSplitUniform,
  tags: ["autodocs"],
  parameters: {
    layout: "fullscreen",
    a11y: {
...
} satisfies Meta<typeof LandingTriSplitUniform>;
