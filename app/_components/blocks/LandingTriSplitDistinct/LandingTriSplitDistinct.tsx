...
import "./LandingTriSplitDistinct.css";

export interface LandingTriSplitDistinctProps {
  hrefTattoo: string;
  hrefStage: string;
  hrefArt: string;
  delay?: number;
...
export function LandingTriSplitDistinct({
  hrefTattoo,
  hrefStage,
  hrefArt,
  ...
  return (
    <div className={rootClass}>
      <a
        ...
        className="ltrd-panel group relative flex min-h-[55vh] flex-1 flex-col items-center justify-center overflow-hidden bg-tattoo-bg p-6 transition-transform duration-300 hover:scale-[1.01] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--tattoo-accent)] sm:p-8 sm:min-h-[50vh] lg:min-h-screen"
      >
        <div
        ...
        <div
          className="ltrd-curtain ltrd-curtain--up ltrd-curtain--dark"
          style={{ transitionDelay: `${delayTattoo}ms` }}
          aria-hidden="true"
        />
      </a>

      {/* TODO: define token --scenic-accent in globals.css */}
      <a
        href={hrefStage}
        aria-label={stageAriaLabel}
        className="ltrd-panel group relative flex min-h-[55vh] flex-1 flex-col items-center justify-center overflow-hidden bg-tattoo-bg p-6 transition-transform duration-300 hover:scale-[1.01] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-warning)] sm:p-8 sm:min-h-[50vh] lg:min-h-screen"
      >
        <div
          className="absolute inset-0 bg-cover bg-center transition-transform duration-700 ease-out group-hover:scale-105"
        ...
        <div className="relative z-10 text-center">
          <span className="mb-3 block font-[family-name:var(--font-scenic)] text-xs font-normal uppercase tracking-[0.3em] text-[var(--color-warning)] sm:mb-4 sm:text-sm">
            {stageEyebrow}
          </span>
          {/* Bebas Neue ships a single weight (400), so keep font-normal instead
              of font-bold — the browser would otherwise synthesize the bold. */}
          <h2 className="mb-4 font-[family-name:var(--font-scenic)] text-4xl font-normal uppercase tracking-tight text-tattoo-text sm:mb-6 sm:text-5xl lg:text-7xl">
            {stageTitle}
          </h2>
          <p className="mx-auto mb-6 max-w-md text-base text-tattoo-text-muted sm:mb-8 sm:text-lg">
            {stageDescription}
          </p>
          <div className="inline-flex items-center gap-2 font-[family-name:var(--font-scenic)] font-normal text-[var(--color-warning)]">
            <span>{stageCta}</span>
            <ArrowRight
              className="h-5 w-5 transition-transform duration-300 group-hover:translate-x-1"
              aria-hidden="true"
        ...
        <div
          className="ltrd-curtain ltrd-curtain--down ltrd-curtain--dark"
      ...
      <a
        ...
        className="ltrd-panel group relative flex min-h-[55vh] flex-1 flex-col items-center justify-center overflow-hidden bg-tattoo-bg p-6 transition-transform duration-300 hover:scale-[1.01] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--art-accent)] sm:p-8 sm:min-h-[50vh] lg:min-h-screen"
      >
        <div
          className="absolute inset-0 bg-cover bg-center transition-transform duration-700 ease-out group-hover:scale-105"
...
export default LandingTriSplitDistinct;
