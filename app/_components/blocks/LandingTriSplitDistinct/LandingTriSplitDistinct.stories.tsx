...
import { LandingTriSplitDistinct } from "./LandingTriSplitDistinct";

const meta = {
  title: "Blocks/LandingTriSplitDistinct",
  component: LandingTriSplitDistinct,
  tags: ["autodocs"],
  parameters: {
    layout: "fullscreen",
    a11y: {
...
} satisfies Meta<typeof LandingTriSplitDistinct>;
