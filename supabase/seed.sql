...
-- Tattoo categories must exist before styles reference them.
INSERT INTO tattoo_style_categories (name, slug, sort_order) VALUES
...
-- Tattoo Styles
INSERT INTO tattoo_styles (name, slug, sort_order, category_id)
SELECT name, slug, sort_order, id FROM tattoo_style_categories;
...
-- About Sections
INSERT INTO about_sections (section_type, title, content, sort_order, is_published) VALUES
...
-- Sample Exhibitions
INSERT INTO exhibitions (title, slug, description, venue, location, start_date, end_date, is_current, sort_order, is_published) VALUES
  ('Conexiones Contemporáneas', 'conexiones-contemporaneas', 'Exposición colectiva de arte contemporáneo chileno.', 'Galería Fundación', 'Santiago', '2026-03-01', '2026-06-30', true, 1, true),
  ('Formas del Silencio', 'formas-del-silencio', 'Muestra individual de pintura y dibujo.', 'Centro Cultural La Moneda', 'Santiago', '2025-08-01', '2025-10-30', false, 2, true),
  ('Nuevas Narrativas', 'nuevas-narrativas', 'Exposición colectiva de artistas emergentes.', 'Galería Animal', 'Santiago', '2025-03-01', '2025-05-30', false, 3, true);

-- Sample Artworks
INSERT INTO artworks (title, slug, description, image_path, medium, year, is_featured, sort_order, is_published) VALUES
  ('Serenidad', 'serenidad', 'Óleo sobre lienzo que explora la calma del paisaje interior.', '/placeholder-art-1.jpg', 'Óleo sobre lienzo', 2025, true, 1, true),
  ('Raíces', 'raices', 'Ilustración digital sobre conexiones familiares y origen.', '/placeholder-art-2.jpg', 'Ilustración digital', 2025, true, 2, true),
  ('Fluir', 'fluir', 'Acuarela que captura el movimiento del agua.', '/placeholder-art-3.jpg', 'Acuarela', 2024, false, 3, true),
  ('Estructuras', 'estructuras', 'Dibujo en carbón sobre papel de formato grande.', '/placeholder-art-4.jpg', 'Carbón sobre papel', 2024, false, 4, true),
  ('Luz Interior', 'luz-interior', 'Serie de pinturas sobre la introspección.', '/placeholder-art-5.jpg', 'Mixta sobre tela', 2024, false, 5, true);
